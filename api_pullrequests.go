 ...
 * @param optional nil or *PullrequestsTargetUserGetOpts - Optional Parameters:
     * @param "State" (optional.String) -  Only return pull requests that are in this state. This parameter can be repeated.

@return PaginatedPullrequests
*/

type PullrequestsTargetUserGetOpts struct { 
	State optional.String
}

func (a *PullrequestsApiService) PullrequestsTargetUserGet(ctx context.Context, targetUser string, username string, localVarOptionals *PullrequestsTargetUserGetOpts) (PaginatedPullrequests, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param username This can either be the username or the UUID of the account, surrounded by curly-braces, for example: &#x60;{account UUID}&#x60;. An account is either a team or user. 
 * @param repoSlug This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: &#x60;{repository UUID}&#x60;. 
 * @param optional nil or *RepositoriesUsernameRepoSlugPullrequestsGetOpts - Optional Parameters:
     * @param "State" (optional.String) -  Only return pull requests that are in this state. This parameter can be repeated.

@return PaginatedPullrequests
*/

type RepositoriesUsernameRepoSlugPullrequestsGetOpts struct { 
	State optional.String
}

func (a *PullrequestsApiService) RepositoriesUsernameRepoSlugPullrequestsGet(ctx context.Context, username string, repoSlug string, localVarOptionals *RepositoriesUsernameRepoSlugPullrequestsGetOpts) (PaginatedPullrequests, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
