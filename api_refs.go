 ...
 * @param optional nil or *RepositoriesUsernameRepoSlugRefsBranchesGetOpts - Optional Parameters:
...
type RepositoriesUsernameRepoSlugRefsBranchesGetOpts struct { 
	Q optional.String
	Sort optional.String
}

func (a *RefsApiService) RepositoriesUsernameRepoSlugRefsBranchesGet(ctx context.Context, username string, repoSlug string, localVarOptionals *RepositoriesUsernameRepoSlugRefsBranchesGetOpts) (PaginatedBranches, *http.Response, error) {
	var (
 ...
 * @param username  This can either be the username or the UUID of the user, surrounded by curly-braces, for example: &#x60;{user UUID}&#x60;. 
 * @param repoSlug  This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: &#x60;{repository UUID}&#x60;. 
 * @param optional nil or *RepositoriesUsernameRepoSlugRefsGetOpts - Optional Parameters:
     * @param "Q" (optional.String) -   Query string to narrow down the response as per [filtering and sorting](../../../../../../meta/filtering).
...
type RepositoriesUsernameRepoSlugRefsGetOpts struct { 
	Q optional.String
	Sort optional.String
}

func (a *RefsApiService) RepositoriesUsernameRepoSlugRefsGet(ctx context.Context, username string, repoSlug string, localVarOptionals *RepositoriesUsernameRepoSlugRefsGetOpts) (PaginatedRefs, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param username  This can either be the username or the UUID of the user, surrounded by curly-braces, for example: &#x60;{user UUID}&#x60;. 
 * @param repoSlug  This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: &#x60;{repository UUID}&#x60;. 
 * @param optional nil or *RepositoriesUsernameRepoSlugRefsTagsGetOpts - Optional Parameters:
     * @param "Q" (optional.String) -   Query string to narrow down the response as per [filtering and sorting](../../../../../../meta/filtering).
...
type RepositoriesUsernameRepoSlugRefsTagsGetOpts struct { 
	Q optional.String
	Sort optional.String
}

func (a *RefsApiService) RepositoriesUsernameRepoSlugRefsTagsGet(ctx context.Context, username string, repoSlug string, localVarOptionals *RepositoriesUsernameRepoSlugRefsTagsGetOpts) (PaginatedTags, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
