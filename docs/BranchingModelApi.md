...
------------- | ------------- | -------------
[**RepositoriesUsernameRepoSlugBranchingModelGet**](BranchingModelApi.md#RepositoriesUsernameRepoSlugBranchingModelGet) | **Get** /repositories/{username}/{repo_slug}/branching-model | 
[**RepositoriesUsernameRepoSlugBranchingModelSettingsGet**](BranchingModelApi.md#RepositoriesUsernameRepoSlugBranchingModelSettingsGet) | **Get** /repositories/{username}/{repo_slug}/branching-model/settings | 
[**RepositoriesUsernameRepoSlugBranchingModelSettingsPut**](BranchingModelApi.md#RepositoriesUsernameRepoSlugBranchingModelSettingsPut) | **Put** /repositories/{username}/{repo_slug}/branching-model/settings | 


# **RepositoriesUsernameRepoSlugBranchingModelGet**
> BranchingModel RepositoriesUsernameRepoSlugBranchingModelGet(ctx, username, repoSlug)
...
> BranchingModelSettings RepositoriesUsernameRepoSlugBranchingModelSettingsGet(ctx, username, repoSlug)
...
# **RepositoriesUsernameRepoSlugBranchingModelSettingsPut**
> BranchingModelSettings RepositoriesUsernameRepoSlugBranchingModelSettingsPut(ctx, username, repoSlug)
