...
# **RepositoriesGet**
> PaginatedRepositories RepositoriesGet(ctx, after)
...
> PaginatedRepositories RepositoriesUsernameGet(ctx, username, role)
...
> Commitstatus RepositoriesUsernameRepoSlugCommitNodeStatusesBuildPost(ctx, username, node, repoSlug, body)
...
> RepositoriesUsernameRepoSlugDelete(ctx, username, repoSlug, redirectTo)
...
> PaginatedFiles RepositoriesUsernameRepoSlugFilehistoryNodePathGet(ctx, username, node, path, repoSlug, renames, q, sort)
...
> Repository RepositoriesUsernameRepoSlugForksPost(ctx, username, repoSlug, body)
...
> Repository RepositoriesUsernameRepoSlugPost(ctx, username, repoSlug, body)
...
> Repository RepositoriesUsernameRepoSlugPut(ctx, username, repoSlug, body)
...
> PaginatedTreeentries RepositoriesUsernameRepoSlugSrcGet(ctx, username, repoSlug, format)
...
> PaginatedTreeentries RepositoriesUsernameRepoSlugSrcNodePathGet(ctx, username, node, path, repoSlug, format, q, sort, maxDepth)
...
> RepositoriesUsernameRepoSlugSrcPost(ctx, username, repoSlug, message, author, parents, files, files2, branch)
...
> PaginatedRepositoryPermissions UserPermissionsRepositoriesGet(ctx, q, sort)
