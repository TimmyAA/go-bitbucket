...
*/
func (a *BranchingModelApiService) RepositoriesUsernameRepoSlugBranchingModelGet(ctx context.Context, username string, repoSlug string) (BranchingModel, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/repositories/{username}/{repo_slug}/branching-model"
...
*/
func (a *BranchingModelApiService) RepositoriesUsernameRepoSlugBranchingModelSettingsGet(ctx context.Context, username string, repoSlug string) (BranchingModelSettings, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/repositories/{username}/{repo_slug}/branching-model/settings"
	localVarPath = strings.Replace(localVarPath, "{"+"username"+"}", fmt.Sprintf("%v", username), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"repo_slug"+"}", fmt.Sprintf("%v", repoSlug), -1)
...
@return BranchingModelSettings
*/
func (a *BranchingModelApiService) RepositoriesUsernameRepoSlugBranchingModelSettingsPut(ctx context.Context, username string, repoSlug string) (BranchingModelSettings, *http.Response, error) {
	var (
