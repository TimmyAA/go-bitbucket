 ...
 * @param optional nil or *SnippetsUsernameEncodedIdRevisionDiffGetOpts - Optional Parameters:
     * @param "Path" (optional.String) -  When used, only one the diff of the specified file will be returned.


*/

type SnippetsUsernameEncodedIdRevisionDiffGetOpts struct { 
	Path optional.String
}

func (a *SnippetsApiService) SnippetsUsernameEncodedIdRevisionDiffGet(ctx context.Context, username string, encodedId string, revision string, localVarOptionals *SnippetsUsernameEncodedIdRevisionDiffGetOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
